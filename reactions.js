...
/* ═══════════════════════════════════════════════════════════════
   EMOJIS OFICIAIS UNICODE 17.0 (Setembro 2025)
   3.953 emojis RGI — organizados nas 10 categorias oficiais
   ═══════════════════════════════════════════════════════════════ */
...
export async function mountReactions(container, opts = {}) {
  ...
  // categorias: brilho (custom) + todas as oficiais Unicode 17.0
  const categories = {
